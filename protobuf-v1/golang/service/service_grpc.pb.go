...
type DogServiceClient interface {
	GetBreed(ctx context.Context, in *GetBreedRequest, opts ...grpc.CallOption) (*GetBreedResponse, error)
}
...
func (c *dogServiceClient) GetBreed(ctx context.Context, in *GetBreedRequest, opts ...grpc.CallOption) (*GetBreedResponse, error) {
	out := new(GetBreedResponse)
	err := c.cc.Invoke(ctx, "/protobuf.service.DogService/GetBreed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DogServiceServer interface {
	GetBreed(context.Context, *GetBreedRequest) (*GetBreedResponse, error)
...
func (UnimplementedDogServiceServer) GetBreed(context.Context, *GetBreedRequest) (*GetBreedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBreed not implemented")
}
...
func _DogService_GetBreed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBreedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DogServiceServer).GetBreed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.service.DogService/GetBreed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DogServiceServer).GetBreed(ctx, req.(*GetBreedRequest))
	}
...
var DogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.service.DogService",
	HandlerType: (*DogServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetBreed",
			Handler:    _DogService_GetBreed_Handler,
		},
	},
